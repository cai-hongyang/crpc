...
inline void RegisterRequest::set_name(std::string&& value) {
  ...
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:chat.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:chat.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:chat.RegisterRequest.name)
}
...
inline const std::string& RegisterRequest::pwd() const {
  // @@protoc_insertion_point(field_get:chat.RegisterRequest.pwd)
  return _internal_pwd();
}
inline void RegisterRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:chat.RegisterRequest.pwd)
}
inline std::string* RegisterRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:chat.RegisterRequest.pwd)
  return _internal_mutable_pwd();
}
...
inline void RegisterRequest::set_pwd(std::string&& value) {
  ...
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:chat.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:chat.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:chat.RegisterRequest.pwd)
}
...
inline std::string* RegisterRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:chat.RegisterRequest.pwd)
...
inline void RegisterRequest::set_allocated_pwd(std::string* pwd) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:chat.RegisterRequest.pwd)
}
...
inline const ::chat::ResultCode& RegisterResponse::_internal_result() const {
  const ::chat::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::chat::ResultCode*>(
      &::chat::_ResultCode_default_instance_);
}
inline const ::chat::ResultCode& RegisterResponse::result() const {
  // @@protoc_insertion_point(field_get:chat.RegisterResponse.result)
  return _internal_result();
}
inline ::chat::ResultCode* RegisterResponse::release_result() {
  // @@protoc_insertion_point(field_release:chat.RegisterResponse.result)
  
  ::chat::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::chat::ResultCode* RegisterResponse::_internal_mutable_result() {
...
inline ::chat::ResultCode* RegisterResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:chat.RegisterResponse.result)
  return _internal_mutable_result();
}
inline void RegisterResponse::set_allocated_result(::chat::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:chat.RegisterResponse.result)
}
...
inline bool RegisterResponse::sucess() const {
  // @@protoc_insertion_point(field_get:chat.RegisterResponse.sucess)
...
inline void RegisterResponse::set_sucess(bool value) {
  ...
  // @@protoc_insertion_point(field_set:chat.RegisterResponse.sucess)
}
